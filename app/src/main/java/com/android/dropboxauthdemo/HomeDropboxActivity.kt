...
import com.android.dropboxauthdemo.api.DropboxUploadApiResponse
import com.android.dropboxauthdemo.api.GetCurrentAccountResult
 ...
 */
class HomeDropboxActivity : BaseSampleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        openWithButton.setOnClickListener {
            val openWithIntent = Intent(this@HomeDropboxActivity, OpenWithActivity::class.java)
